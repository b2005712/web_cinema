        ...
        <div class="col-md-12">
            <div class="card">
                <form method="post" action="/admin/movie/create" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <p class="text-uppercase text-sm">Thêm</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="showTime">Thời lượng(Phút)</label>
                                    <input id="showTime" class="form-control" name="showTime" placeholder="Thời lượng"
                                           type="number" value="">
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="movie_title">Thể loại phim</h5>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control director-input" name="director">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="releaseDate">Ngày khởi chiếu</label>
                                    <input name="releaseDate"  id="releaseDate" class="form-control datepicker" placeholder="Chọn ngày" type="text">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="endDate">Ngày kết thúc</label>
                                    <input id="endDate" name="endDate" class="form-control datepicker" placeholder="Chọn ngày" type="text">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="casts" class="form-control cast-input" name="cast">
                                </div>
                            </div>
                            <div class="col-md-6">
